...
public class SwitchView extends View {
    private final int DEFAULT_COLOR_PRIMARY = 0xFF05B0FF;
    private final int DEFAULT_COLOR_PRIMARY_DARK = 0xFF29292B;
    ...
    protected void onDraw(Canvas canvas) {
        ...
        paint.setColor(isOn ? colorPrimary : 0xff808080);
        ...
        paint.setStyle(Paint.Style.FILL);
        paint.setColor(0xff29292B);
        canvas.drawPath(bPath, paint);
        paint.setStyle(Paint.Style.STROKE);
        paint.setStrokeWidth(bStrokeWidth * 0.5f);
        paint.setColor(isOn ? colorPrimaryDark : 0xFF29292B);
        canvas.drawPath(bPath, paint);
        canvas.restore();
