...
import com.wind.carmanager.model.CurrentLocation;
...
public class MapUtil {
    ...
    public void moveMapToCarPosition(double latitude, double longitude){
        baiduMap.setMyLocationEnabled(true);
        mLastTarget = new LatLng(latitude, longitude);
        ...
        baiduMap.setMyLocationConfiguration(new MyLocationConfiguration(
                MyLocationConfiguration.LocationMode.FOLLOWING, true,  BitmapUtil.bmCar, 0 , 0));
